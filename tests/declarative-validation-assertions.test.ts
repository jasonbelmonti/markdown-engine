...
describe("declarative validation assertion proof", () => {
  ...
  it("evaluates frontmatterShape required presence and typed fields", () => {
    const document = normalize(
      parse(
        [
          "---",
  ...
  it("reports frontmatterShape presence failures", () => {
  ...
  it("reports frontmatterShape missing, wrong-type, and empty string fields", () => {
    const document = normalize(
      parse(
        [
          "---",
  ...
  it("allows empty frontmatterShape string fields unless nonEmpty is configured", () => {
