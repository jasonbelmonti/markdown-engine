...
const expectedRepeatabilityCaseNames = [
  ...
  "declarative-validation:v2-table-columns-exact-result:compact",
  "declarative-validation:v2-table-columns-exact-result:pretty",
  "declarative-validation:v2-table-columns-exact-evidence:compact",
  "declarative-validation:v2-table-columns-exact-evidence:pretty",
