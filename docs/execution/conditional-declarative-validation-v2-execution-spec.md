...
| Related tickets | `BEL-1075`; `BEL-1076`; follow-up implementation tickets required for grouped rules, rule-level `when`, v2 result contract, and downstream design-spec profile exercise before those packages start |
...
| DEP-2 | Dependency | Implementation tickets or approved no-ticket decisions are required before starting grouped rules, `when`, v2 result contract, and downstream exercise packages. | Project owner | Yes for corresponding package starts | Create/update tickets before `WP-1`, `WP-4`, `WP-5`, and `WP-6` start, or record project-owner approval to execute from this spec alone. |
...
Sequencing principle: Retire public contract, compatibility, evidence, and diagnostic-shape risks before feature breadth. After the v2 shell proves the critical path, add local assertion extensions (`WP-2`, `WP-3`) before grouped and applicability control flow (`WP-4`, `WP-5`), then close with downstream and release evidence (`WP-6`).
...
| WP-6 | Complete v2 contract docs, CLI parity, downstream design-spec exercise, repeatability, boundary audit, release readiness, rollback notes, and handoff evidence. | Implementer / Downstream owner | PKG-1 / PKG-4 / PKG-5 | `docs/contracts/declarative-validation.md`; `README.md`; `CHANGELOG.md`; `SECURITY.md`; `src/cli/**` if parity gaps remain; `tests/**`; `fixtures/declarative-validation/conditionals/**`; `scripts/**`; `package.json`; `docs/evidence/**` | Production implementation files except bug fixes approved by `DEV-*`; rich IR/parser internals | WP-1 through WP-5 outputs, contract review comments, downstream motivating profile cases | `EVD-6`; `EVD-7`; `EVD-8`; `EVD-9`; release-readiness handoff | WP-2 through WP-5 and MS-2/MS-3 prerequisites | Maintainers can decide merge/release from complete evidence and downstream proof. | RISK-1 / RISK-2 / RISK-3 / RISK-4 / RISK-6 | MS-4 | VAL-1 through VAL-14 | Contract docs pass, boundary audit passes, repeatability proves deterministic v2 API/CLI/evidence, downstream exercise passes/fails expected cases, release verification passes, rollback and handoff evidence are recorded. |
...
6. Stop for `MS-3` approval before final merge preparation.
7. Execute `WP-6`; stop for `MS-4` before release, tag, publication, downstream adoption claim, or completion claim.
...
Integration points: `WP-1` establishes v2 public result/evidence and schema dispatch; `WP-2` and `WP-3` integrate through assertion schema/compiler/evaluator contracts; `WP-4` and `WP-5` integrate through nested result/evidence contracts; `WP-6` integrates all packages through CLI, docs, repeatability, downstream, boundary, and release gates.
...
| EVD-8 | `docs/evidence/conditional-v2-evd-8-downstream-design-spec-exercise.md` | Downstream fixture names, Section 4/15/R1/mixed-ID/Section 11/17 pass/fail results, false-acceptance coverage notes, and downstream owner approval input. | WP-6 / MS-4 |
| EVD-9 | `docs/evidence/conditional-v2-evd-9-release-readiness-handoff.md` | `npm run release:verify` output, milestone approval log, rollback decision, release or containment decision, unresolved follow-ups, exact branch or commit, and handoff record. | WP-6 / MS-4 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| SRC-1 / Approved v2 design | SURF-1 through SURF-9 | PKG-1 through PKG-5 | WP-1 through WP-6 | MS-1 through MS-4 | CTRL-1 through CTRL-9 | VAL-1 through VAL-14 | REV-1 through REV-5 | REL-1 through REL-5 / OBS-1 through OBS-7 | EVD-1 through EVD-9 |
| SRC-2 / Motivating downstream grammar gap | SURF-3 / SURF-5 / SURF-7 | PKG-2 / PKG-3 / PKG-4 | WP-2 / WP-3 / WP-4 / WP-5 / WP-6 | MS-2 / MS-4 | CTRL-3 / CTRL-5 | VAL-4 / VAL-5 / VAL-6 / VAL-7 / VAL-13 | REV-3 | REL-3 / OBS-6 | EVD-2 / EVD-3 / EVD-4 / EVD-5 / EVD-8 |
| SRC-3 / Controlled consumers and clean v2 API preference | SURF-1 / SURF-2 / SURF-6 | PKG-1 | WP-1 / WP-4 / WP-5 / WP-6 | MS-1 / MS-3 / MS-4 | CTRL-2 / CTRL-3 | VAL-8 / VAL-10 / VAL-11 | REV-1 / REV-5 | REL-1 / REL-5 / OBS-3 | EVD-1 / EVD-6 |
| SRC-4 / Current v1 public contract | SURF-1 / SURF-2 / SURF-6 / SURF-7 | PKG-1 / PKG-4 | WP-1 / WP-6 | MS-1 / MS-3 / MS-4 | CTRL-2 | VAL-1 / VAL-10 / VAL-11 | REV-1 / REV-5 | REL-1 / OBS-1 | EVD-1 / EVD-6 / EVD-9 |
| SRC-5 / Existing declarative validation architecture | SURF-2 through SURF-8 | PKG-1 through PKG-5 | WP-1 through WP-6 | MS-1 through MS-4 | CTRL-4 / CTRL-6 | VAL-1 / VAL-12 / VAL-14 | REV-2 / REV-4 | REL-2 / OBS-5 | EVD-7 / EVD-9 |
| SRC-6 / High-blast-radius proposed implementation surface | SURF-1 through SURF-9 | PKG-1 through PKG-5 | WP-1 through WP-6 | MS-1 through MS-4 | CTRL-1 / CTRL-8 / CTRL-9 | VAL-14 | REV-2 / REV-5 | REL-2 / REL-4 | EVD-1 through EVD-9 |
| SRC-7 / User request for execution spec | SURF-9 | PKG-5 | WP-6 | MS-4 | CTRL-9 | VAL-14 | REV-5 | REL-4 | EVD-9 |
| OBJ-1 / Grouped alternatives | SURF-3 / SURF-4 / SURF-5 / SURF-7 | PKG-2 / PKG-3 / PKG-4 | WP-4 / WP-6 | MS-3 / MS-4 | CTRL-3 | VAL-2 / VAL-3 / VAL-6 / VAL-8 / VAL-9 / VAL-13 | REV-1 / REV-2 / REV-3 | REL-3 / OBS-3 / OBS-6 | EVD-4 / EVD-8 |
| OBJ-2 / Rule-level applicability | SURF-3 / SURF-4 / SURF-5 / SURF-7 | PKG-2 / PKG-3 / PKG-4 | WP-5 / WP-6 | MS-3 / MS-4 | CTRL-3 / CTRL-4 | VAL-3 / VAL-7 / VAL-8 / VAL-9 / VAL-13 | REV-1 / REV-2 / REV-3 | REL-3 / OBS-3 / OBS-6 | EVD-5 / EVD-8 |
| OBJ-3 / ID count bounds | SURF-3 / SURF-4 / SURF-5 / SURF-7 | PKG-2 / PKG-3 / PKG-4 | WP-2 / WP-6 | MS-2 / MS-4 | CTRL-1 | VAL-4 / VAL-13 | REV-2 / REV-3 | REL-3 / OBS-6 | EVD-2 / EVD-8 |
| OBJ-4 / Table-column coverage | SURF-3 / SURF-4 / SURF-5 / SURF-7 | PKG-2 / PKG-3 / PKG-4 | WP-3 / WP-6 | MS-2 / MS-4 | CTRL-5 / CTRL-6 | VAL-5 / VAL-13 | REV-2 / REV-3 | REL-3 / OBS-6 | EVD-3 / EVD-8 |
| OBJ-5 / Preserve v1 behavior | SURF-1 / SURF-2 / SURF-6 / SURF-7 | PKG-1 / PKG-4 | WP-1 / WP-6 | MS-1 / MS-3 / MS-4 | CTRL-2 | VAL-1 / VAL-11 / VAL-14 | REV-1 / REV-5 | REL-1 / OBS-1 | EVD-1 / EVD-6 / EVD-9 |
| OBJ-6 / Clean v2 public result/evidence semantics | SURF-1 / SURF-2 / SURF-6 / SURF-7 | PKG-1 / PKG-4 | WP-1 / WP-4 / WP-5 / WP-6 | MS-1 / MS-3 / MS-4 | CTRL-3 / CTRL-7 | VAL-8 / VAL-9 / VAL-10 / VAL-11 | REV-1 / REV-5 | REL-5 / OBS-3 / OBS-4 | EVD-1 / EVD-4 / EVD-5 / EVD-6 / EVD-7 |
...
| RISK-1 | SURF-1 / SURF-2 / SURF-6 / SURF-7 | PKG-1 / PKG-4 | WP-1 / WP-4 / WP-5 / WP-6 | MS-1 / MS-3 / MS-4 | CTRL-2 / CTRL-7 | VAL-1 / VAL-8 / VAL-10 / VAL-11 | REV-1 / REV-5 | REL-1 / REL-5 | EVD-1 / EVD-6 / EVD-7 |
| RISK-2 | SURF-2 / SURF-5 / SURF-7 | PKG-1 / PKG-3 / PKG-4 | WP-4 / WP-5 / WP-6 | MS-3 / MS-4 | CTRL-3 / CTRL-7 | VAL-6 / VAL-7 / VAL-8 / VAL-9 | REV-1 / REV-2 | OBS-3 / OBS-4 | EVD-4 / EVD-5 / EVD-7 |
| RISK-3 | SURF-1 through SURF-9 | PKG-1 through PKG-5 | WP-1 through WP-6 | MS-1 through MS-4 | CTRL-1 / CTRL-8 / CTRL-9 | VAL-14 | REV-2 / REV-5 | REL-2 / REL-4 | EVD-1 through EVD-9 |
| RISK-4 | SURF-3 / SURF-5 / SURF-7 / SURF-10 | PKG-2 / PKG-3 / PKG-4 | WP-3 / WP-6 | MS-2 / MS-4 | CTRL-5 / CTRL-6 | VAL-5 / VAL-13 | REV-2 / REV-3 | REL-3 / OBS-6 | EVD-3 / EVD-8 |
| RISK-5 | SURF-3 / SURF-5 / SURF-7 | PKG-2 / PKG-3 / PKG-4 | WP-2 / WP-6 | MS-2 / MS-4 | CTRL-1 | VAL-4 / VAL-13 | REV-2 / REV-3 | REL-3 | EVD-2 / EVD-8 |
| RISK-6 | SURF-3 / SURF-5 / SURF-8 / SURF-10 | PKG-2 / PKG-3 / PKG-5 | WP-1 / WP-4 / WP-5 / WP-6 | MS-1 / MS-3 / MS-4 | CTRL-4 / CTRL-6 | VAL-2 / VAL-12 | REV-4 | OBS-5 | EVD-7 |
